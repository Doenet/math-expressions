...
exports.complex_evaluate = function(expr, bindings) {
    return parser.ast.to.complexFunction( expr.tree )( bindings );
};

exports.real_evaluate = function(expr, bindings) {
    return parser.ast.to.realFunction( expr.tree )( bindings );
};
