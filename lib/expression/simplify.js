...
function simplify_integers_in_roots(tree) {
  ...
  /**
   * Factor n as n_outside^root * n_inside, where n_inside is not an integer raised to the power of root.
   * Returns an object { n_outside, n_inside }.
   */
...
function collect_like_terms_factors(expr_or_tree, assumptions, max_digits) {
  ...
  // simplify square roots of integer powers
  transformations.push([
    ["apply", "sqrt", ["*", "a", ["^", "x", "n"]]],
    [
      "*",
      [
        "apply",
        "sqrt",
        ["*", "a", ["^", "x", ["apply", "mod", ["tuple", "n", 2]]]],
      ],
      [
        "^",
        "x",
        ["/", ["+", "n", ["-", ["apply", "mod", ["tuple", "n", 2]]]], 2],
      ],
    ],
    {
      variables: {
        a: true,
        x: (v) => is_positive(v, assumptions, false),
  ...
  transformations.push([
    ...
    ],
    {
      variables: {
        a: true,
        x: (v) =>
          !is_positive(v, assumptions, false) && is_real(v, assumptions),
        n: (v) => Number.isInteger(v) && v > 1,
      },
      evaluate_numbers: true,
      evaluate_functions: true,
  ...
  // simplify cube roots of integer powers
  transformations.push([
    ["apply", "cbrt", ["*", "a", ["^", "x", "n"]]],
    [
      "*",
      [
        "apply",
        "cbrt",
        ["*", "a", ["^", "x", ["apply", "mod", ["tuple", "n", 3]]]],
      ],
      [
        "^",
        "x",
        ["/", ["+", "n", ["-", ["apply", "mod", ["tuple", "n", 3]]]], 3],
      ],
    ],
    {
      variables: {
        a: true,
        x: (v) => is_real(v, assumptions),
        n: (v) => Number.isInteger(v) && v > 2,
      },
      evaluate_numbers: true,
      evaluate_functions: true,
      max_digits: max_digits,
  ...
  // simplify mth roots of integer powers
  transformations.push([
    ["apply", "nthroot", ["tuple", ["*", "a", ["^", "x", "n"]], "m"]],
    [
      "*",
      [
        "apply",
  ...
  transformations.push([
    ...
    ],
    {
      variables: {
        ...
        x: (v) => is_real(v, assumptions),
        n: (v) => Number.isInteger(v) && v > 2,
        m: (v) => Number.isInteger(v) && !Number.isInteger(v / 2) && v > 1,
      },
      evaluate_numbers: true,
      evaluate_functions: true,
      max_digits: max_digits,
