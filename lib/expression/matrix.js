...
function vector_add(v1, v2){
    ...
    if(v1.length !== v2.length || (v1[0] !== 'tuple' && v1[0] !== 'vector' && v1[0] !== 'altvector') || (v2[0] !== 'tuple' && v2[0] !== 'vector' && v2[0] !== 'altvector')) {
        throw new Error("Can't add. Those aren't vectors, or the dimensions don't match");
    }
    var v_sum = (v1[0] === 'altvector' && v2[0] === 'altvector') ? ['altvector'] : ['vector'];
    var len = v1.length;
...
function cross_prod(v1, v2){
    ...
    if((v1[0] !== 'tuple' && v1[0] !== 'vector' && v1[0] !== 'altvector') || (v2[0] !== 'tuple' && v2[0] !== 'vector' && v2[0] !== 'altvector')){
    ...
    if (v1.length === 4 && v2.length === 4){
        ...
        let vectorName =(v1[0] === 'altvector' && v2[0] === 'altvector') ? "altvector": "vector";
