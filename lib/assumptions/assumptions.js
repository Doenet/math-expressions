...
function add_assumption(assumptions, expr, exclude_generic) {
...
function add_generic_assumption(assumptions, expr) {
    // add assumption in expr to generic assumptions
...
function remove_assumption(assumptions, expr) {
...
function remove_generic_assumption(assumptions, expr) {
    // remove assumption in expr from generic assumptions
