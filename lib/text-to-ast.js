...
var unsplitSymbols = defaults.unsplitSymbols;
...
function parse(input, context) {
    ...
    // redefine unsplit symbols and function symbols from context
    if (context !== undefined) {
	if(context.allow_simplified_function_application !== undefined)
	    allow_simplified_function_application
	    = context.allow_simplified_function_application;
	if(context.unsplitSymbols !== undefined)
	    unsplitSymbols = context.unsplitSymbols;
	if(context.appliedFunctionSymbols !== undefined)
	    appliedFunctionSymbols = context.appliedFunctionSymbols;
	if(context.functionSymbols !== undefined)
