...
var operators = {
    ...
    "list": function(operands) { return '\\left[ ' + operands.join( ', ' ) + ' \\right]';},
    ...
    "in": function(operands) { return operands[0] + " \\in " + operaands[1]; },
    "notin": function(operands) { return operands[0] + " \\notin " + operaands[1]; },
    "ni": function(operands) { return operands[0] + " \\ni " + operaands[1]; },
    "notni": function(operands) { return operands[0] + " \\not\\ni " + operaands[1]; },
    "subset": function(operands) { return operands[0] + " \\subset " + operaands[1]; },
    "notsubset": function(operands) { return operands[0] + " \\not\\subset " + operaands[1]; },
    "superset": function(operands) { return operands[0] + " \\supset " + operaands[1]; },
    "notsuperset": function(operands) { return operands[0] + " \\not\\supset " + operaands[1]; },
...
function factor(tree) {
    ...
    // Absolute value doesn't need any special parentheses handling
    if (operator === "abs") {
	return operators[operator]( operands.map( function(v,i) { return statement(v); } ));
    }
