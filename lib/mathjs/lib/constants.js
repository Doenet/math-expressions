...
var object = require('mathjs/lib/utils/object');
var bigConstants = require('mathjs/lib/utils/bignumber/constants');
...
function factory (type, config, load, typed, math) {
  ...
  setConstant(math, 'uninitialized', require('mathjs/lib/utils/array').UNINITIALIZED);
