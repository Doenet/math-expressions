...
var round_trip = (input) =>
  converter_ast_to_latex.convert(converter_latex_to_ast.convert(input));
var round_trip_no_blanks = (input) =>
  converter_ast_to_latex_no_blanks.convert(
...
var inputs = [
  ...
  [
    ...
    "\\left|\\sin\\left(\\left|x\\right|\\right)\\right|",
  ],
  ["|\\sin||x|||", "|\\sin(||x||)|"],
  "||x|+|y|+|z||",
  "|x+y < z|",
  ...
  ["\\neg A \\lor B", "(\\lnot A) \\lor B"],
  ["A=1 \\lor B=x/y", "(A=1) \\lor (B=\\frac{x}{y})"],
  ["A \\land B \\Rightarrow C \\lor D", "A \\land B \\implies C \\lor D"],
  ["A \\land B \\Longrightarrow C \\lor D", "A \\land B \\implies C \\lor D"],
  ["A \\land B \\Leftarrow C \\lor D", "A \\land B \\impliedby C \\lor D"],
  ["A \\land B \\Longleftarrow C \\lor D", "A \\land B \\impliedby C \\lor D"],
  ["A \\land B \\Leftrightarrow C \\lor D", "A \\land B \\iff C \\lor D"],
  ["A \\land B \\Longleftrightarrow C \\lor D", "A \\land B \\iff C \\lor D"],
  ["A \\land B \\to C \\lor D", "A \\land B \\rightarrow C \\lor D"],
  [
    "A \\land B \\longrightarrow C \\lor D",
    "A \\land B \\rightarrow C \\lor D",
  ],
  ["A \\land B \\gets C \\lor D", "A \\land B \\leftarrow C \\lor D"],
  ["A \\land B \\longleftarrow C \\lor D", "A \\land B \\leftarrow C \\lor D"],
  [
    "A \\land B \\longleftrightarrow C \\lor D",
    "A \\land B \\leftrightarrow C \\lor D",
  ],
  "\\forall x \\in A, \\exists y > x",
  "x \\in (a,b)",
  ["x \\not\\in (a,b)", "x \\notin (a,b)"],
  "(a,b) \\ni x",
  "(a,b) \\not\\ni x",
  ...
  [
    ...
    "\\begin{bmatrix}0&0&0\\\\1&0&0\\\\0&2&0\\\\0&0&3\\end{bmatrix}",
  ],
  [
    "\\begin{matrix} 1 \\\\ &2 \\\\ &&3& \\end{matrix}",
  ...
  "\\langle x,y \\rangle",
  "\\langle x,y \\rangle'",
  ["\\langle x,y \\rangle^T", "\\langle x,y \\rangle^{T}"],
  "x \\perp y",
  ["x \\bot y", "x \\perp y"],
  "x^{\\perp}",
  ["x^{\\bot}", "x^{\\perp}"],
  ...
  ["\\angle(A,B,C)x", "\\angle(A,B,C)x"],
  ["(\\angle ABC)x", "\\angle(A,B,C)x"],
  "50^{\\circ}",
  "\\$",
  ["$", "\\$"],
  "\\$8",
...
inputs.forEach(function (input) {
  test(input.toString(), function () {
    ...
    else expect(clean(round_trip(input))).toEqual(clean(input));
  });
});
...
inputs_no_show_blanks.forEach(function (input) {
  test(input.toString(), function () {
    ...
    else expect(clean(round_trip_no_blanks(input))).toEqual(clean(input));
  });
});
