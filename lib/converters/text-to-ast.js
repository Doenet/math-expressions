...
const base_text_rules = [
  ...
  ['rightarrow(?![a-zA-Z0-9])', 'RIGHTARROW'],
  ['\u2192', 'RIGHTARROW'], //'→'
  ['\u27f6', 'RIGHTARROW'], //'⟶'

  ['leftarrow(?![a-zA-Z0-9])', 'LEFTARROW'],
  ['\u2190', 'LEFTARROW'], //'←'
  ['\u27f5', 'LEFTARROW'], //'⟵'

  ['leftrightarrow(?![a-zA-Z0-9])', 'LEFTRIGHTARROW'],
  ['\u2194', 'LEFTRIGHTARROW'], //'↔'
  ['\u27f7', 'LEFTRIGHTARROW'], //'⟷'

  ['implies(?![a-zA-Z0-9])', 'IMPLIES'],
  ['\u21d2', 'IMPLIES'], //'⇒'
  ['\u27f9', 'IMPLIES'], //'⟹'

  ['impliedby(?![a-zA-Z0-9])', 'IMPLIEDBY'],
  ['\u21d0', 'IMPLIEDBY'], //'⇐'
  ['\u27f8', 'IMPLIEDBY'], //'⟸'
...
const unsplitSymbolsDefault = ['alpha', 'beta', 'gamma', 'Gamma', 'delta', 'Delta', 'epsilon', 'zeta', 'eta', 'theta', 'Theta', 'iota', 'kappa', 'lambda', 'Lambda', 'mu', 'nu', 'xi', 'Xi', 'pi', 'Pi', 'rho', 'sigma', 'Sigma', 'tau', 'Tau', 'upsilon', 'Upsilon', 'phi', 'Phi', 'chi', 'psi', 'Psi', 'omega', 'Omega', 'angle', 'deg', 'emptyset'];
