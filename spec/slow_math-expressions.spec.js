...
describe("expression", function () {
  ...
  var nonequivalences = [
    ...
    ["e^(10x)", "e^(10x)+sin^2(x)+cos^2(x)"],
    ["e^(-10x)", "e^(-10x)+0.0000001"],
    ["e^(10x)", "e^(10x)+0.0000001"],
    ["e^(-10x^2)", "e^(-10x^2)+C"],
    ["e^(10x^2)", "e^(10x^2)+C"],
    ["sin(10x)", "sin(10x)+C"],
    ["cos(10x)", "cos(10x)+C"],
    ["e^(10x)+sin(10x)", "e^(10x)+sin(10x)+0.0000001"],
    ["e^(10x)+cos(10x)", "e^(10x)+cos(10x)+0.0000001"],
    ["e^(10x)+tan(10x)", "e^(10x)+tan(10x)+0.0000001"],
    ["e^(10x)+csc(10x)", "e^(10x)+csc(10x)+0.0000001"],
    ["e^(10x)+sec(10x)", "e^(10x)+sec(10x)+0.0000001"],
    ["e^(10x)+cot(10x)", "e^(10x)+cot(10x)+0.0000001"],
    ["e^(10x)=0", "e^(10x)+C=0"],
    ["e^(10x)=0", "e^(10x)+0.0000001=0"],
    ["cos(10x) < 0", "cos(10x)+C < 0"],
    ["cos(10x) < 0", "cos(10x)+0.0000001 < 0"],
    ["(e^(10x),5)", "(e^(10x)+C,5)"],
    ["(e^(10x^2),5)", "(e^(10x^2)+0.0000001,5)"],
