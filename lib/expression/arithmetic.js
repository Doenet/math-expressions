...
exports.add = function (expr1, expr2) {
    return Expression.from(add_ast(expr1.tree, expr2.tree));
}
exports.subtract = function (expr1, expr2) {
    return Expression.from(subtract_ast(expr1.tree, expr2.tree));
}
exports.multiply = function (expr1, expr2) {
    return Expression.from(multiply_ast(expr1.tree, expr2.tree));
}
exports.divide = function (expr1, expr2) {
    return Expression.from(divide_ast(expr1.tree, expr2.tree));
}
exports.pow = function (expr1, expr2) {
    return Expression.from(pow_ast(expr1.tree, expr2.tree));
}
exports.mod = function (expr1, expr2) {
    return Expression.from(mod_ast(expr1.tree, expr2.tree));
}
