...
exports.add = function (expr1, expr2) {
    return expr1.from(add_ast(expr1.tree, expr2.tree));
}
exports.subtract = function (expr1, expr2) {
    return expr1.from(subtract_ast(expr1.tree, expr2.tree));
}
exports.multiply = function (expr1, expr2) {
    return expr1.from(multiply_ast(expr1.tree, expr2.tree));
}
exports.divide = function (expr1, expr2) {
    return expr1.from(divide_ast(expr1.tree, expr2.tree));
}
exports.pow = function (expr1, expr2) {
    return expr1.from(pow_ast(expr1.tree, expr2.tree));
}
exports.mod = function (expr1, expr2) {
    return expr1.from(mod_ast(expr1.tree, expr2.tree));
}
