...
function is_positive_ast(tree, assumptions, strict, original_assumptions) {
	...
	if(operator === '^') {
		...
		let pow_over_two = simplify(['/', operands[1], 2],
						     original_assumptions);
...
export { is_integer, is_real, is_complex, is_nonzero, is_nonnegative, is_positive, is_nonpositive, is_negative, is_integer_ast, is_real_ast, is_complex_ast, is_nonzero_ast, is_positive_ast, is_negative_ast };
