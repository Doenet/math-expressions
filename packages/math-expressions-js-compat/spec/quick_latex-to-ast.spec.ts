...
var trees = {
  ...
  "\\sqrt{x}": ["apply", "sqrt", "x"],
  "\\sqrt[3]{x}": ["apply", "cbrt", "x"],
  "\\sqrt[n]{x}": ["apply", "nthroot", ["tuple", "x", "n"]],
  "\\sin x": ["apply", "sin", "x"],
  "\\sin2": ["apply", "sin", 2],
  "f x": ["*", "f", "x"],
  ...
  "\\forall x": ["forall", "x"],
  "\\forall x \\in A": ["forall", ["in", "x", "A"]],
  "\\exists x": ["exists", "x"],
  "\\exists x \\in A": ["exists", ["in", "x", "A"]],
  "x \\in A": ["in", "x", "A"],
  "x \\notin A": ["notin", "x", "A"],
  "x \\not\\in A": ["notin", "x", "A"],
  "A \\ni x": ["ni", "A", "x"],
  ...
  "A \\Longrightarrow B": ["implies", "A", "B"],
  "A \\impliedby B": ["impliedby", "A", "B"],
  "A \\Leftarrow B": ["impliedby", "A", "B"],
  "A \\Longleftarrow B": ["impliedby", "A", "B"],
  "A \\iff B": ["iff", "A", "B"],
  "A \\Leftrightarrow B": ["iff", "A", "B"],
  "A \\Longleftrightarrow B": ["iff", "A", "B"],
  "A \\land \\lnot B \\implies \\neg C \\lor D": [
    "implies",
    ["and", "A", ["not", "B"]],
    ["or", ["not", "C"], "D"],
  ],
  "A \\land \\lnot B \\impliedby \\neg C \\lor D": [
    "impliedby",
    ["and", "A", ["not", "B"]],
    ["or", ["not", "C"], "D"],
  ],
  ...
  "A \\to B": ["rightarrow", "A", "B"],
  "A \\rightarrow B": ["rightarrow", "A", "B"],
  "A \\longrightarrow B": ["rightarrow", "A", "B"],
  "A \\gets B": ["leftarrow", "A", "B"],
  "A \\leftarrow B": ["leftarrow", "A", "B"],
  "A \\longleftarrow B": ["leftarrow", "A", "B"],
  "A \\leftrightarrow B": ["leftrightarrow", "A", "B"],
  "A \\longleftrightarrow B": ["leftrightarrow", "A", "B"],
  "A \\land \\lnot B \\to \\neg C \\lor D": [
    "rightarrow",
    ["and", "A", ["not", "B"]],
    ["or", ["not", "C"], "D"],
  ...
  "\\begin{matrix} 1E-3 & 3E-12 \\\\ 6E+3& 7E5\\end{matrix}": [
    "matrix",
    ["tuple", 2, 2],
    ["tuple", ["tuple", 0.001, 3e-12], ["tuple", 6000, 700000]],
  ],
  "1.2e-3": ["+", ["*", 1.2, "e"], -3],
  "+2": ["+", 2],
  "\\infty": Infinity,
  "+\\infty": ["+", Infinity],
  "\\infty2": ["*", Infinity, 2],
  "a b\\,c\\!d\\ e\\>f\\;g\\>h\\quad i \\qquad j": [
    "*",
    "a",
    "b",
    "c",
  ...
  "\\begin{pmatrix}a & b\\\\ c\\end{pmatrix}": [
    "matrix",
    ["tuple", 2, 2],
    ["tuple", ["tuple", "a", "b"], ["tuple", "c", 0]],
  ],
  "\\begin{matrix}a & b\\\\ &d\\end{matrix}": [
    "matrix",
    ["tuple", 2, 2],
    ["tuple", ["tuple", "a", "b"], ["tuple", 0, "d"]],
  ],
  "\\begin{pmatrix}a + 3y & 2\\sin(\\theta)\\end{pmatrix}": [
    "matrix",
    ["tuple", 1, 2],
    [
      "tuple",
      ["tuple", ["+", "a", ["*", 3, "y"]], ["*", 2, ["apply", "sin", "theta"]]],
    ],
  ],
  "\\begin{bmatrix}3\\\\ \\\\ 4 & 5\\end{bmatrix}": [
    "matrix",
    ["tuple", 3, 2],
    ["tuple", ["tuple", 3, 0], ["tuple", 0, 0], ["tuple", 4, 5]],
  ],
  "\\begin{matrix}8\\\\1&2&3\\end{matrix}": [
    "matrix",
    ["tuple", 2, 3],
  ...
  "\\frac{d\\operatorname{hello}}{d\\operatorname{bye}}": [
    "derivative_leibniz",
    "hello",
    ["tuple", "bye"],
  ],
  "\\frac{d^2\\theta}{d\\pi^2}": [
    "derivative_leibniz",
    ["tuple", "theta", 2],
    ["tuple", ["tuple", "pi", 2]],
  ],
  "\\frac{d^2\\operatorname{hello}}{d\\operatorname{bye}^2}": [
    "derivative_leibniz",
    ["tuple", "hello", 2],
    ["tuple", ["tuple", "bye", 2]],
  ],
  ...
  "\\frac{\\partial ^2x}{\\partial t^3}": [
    "/",
    ["*", ["^", "partial", 2], "x"],
    ["*", "partial", ["^", "t", 3]],
  ],
  "\\frac{\\partial ^2x}{\\partial s\\partial t}": [
    "partial_derivative_leibniz",
    ["tuple", "x", 2],
    ["tuple", "s", "t"],
  ],
  "\\frac{\\partial ^2x}{\\partial s\\partial ta}": [
    "/",
    ["*", ["^", "partial", 2], "x"],
    ["*", "partial", "s", "partial", "t", "a"],
  ],
  "\\frac{\\partial ^3x}{\\partial s^2\\partial t}": [
    "partial_derivative_leibniz",
    ["tuple", "x", 3],
    ["tuple", ["tuple", "s", 2], "t"],
  ],
  "\\frac{\\partial ^{ 3 }x}{\\partial s^{2}\\partial t}": [
    "partial_derivative_leibniz",
    ["tuple", "x", 3],
    ["tuple", ["tuple", "s", 2], "t"],
  ],
  "\\frac{\\partial ^3x}{\\partial s\\partial t^2}": [
    "partial_derivative_leibniz",
    ["tuple", "x", 3],
    ["tuple", "s", ["tuple", "t", 2]],
  ],
  "\\frac{\\partial ^{3}x}{\\partial s\\partial t^{ 2 }}": [
    "partial_derivative_leibniz",
    ["tuple", "x", 3],
    ["tuple", "s", ["tuple", "t", 2]],
  ],
  "\\frac{\\partial \\theta}{\\partial \\pi}": [
    "partial_derivative_leibniz",
    "theta",
    ["tuple", "pi"],
  ],
  "\\frac{\\partial \\operatorname{hello}}{\\partial \\operatorname{bye}}": [
    "partial_derivative_leibniz",
    "hello",
    ["tuple", "bye"],
  ],
  "\\frac{\\partial ^2\\theta}{\\partial \\pi^2}": [
    "partial_derivative_leibniz",
    ["tuple", "theta", 2],
    ["tuple", ["tuple", "pi", 2]],
  ],
  "\\frac{\\partial ^2\\operatorname{hello}}{\\partial \\operatorname{bye}^2}":
    [
      "partial_derivative_leibniz",
      ["tuple", "hello", 2],
      ["tuple", ["tuple", "bye", 2]],
