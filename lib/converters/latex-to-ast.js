...
const base_latex_rules = [
  ...
  ['\\\\Biggr\\s*\\\\}', 'RBRACE'],
  ['\\\\lfloor', 'LFLOOR'],
  ['\\\\left\\s*\\\\lfloor', 'LFLOOR'],
  ['\\\\bigl\\s*\\\\lfloor', 'LFLOOR'],
  ['\\\\Bigl\\s*\\\\lfloor', 'LFLOOR'],
  ['\\\\biggl\\s*\\\\lfloor', 'LFLOOR'],
  ['\\\\Biggl\\s*\\\\lfloor', 'LFLOOR'],
  ['\\\\rfloor', 'RFLOOR'],
  ['\\\\right\\s*\\\\rfloor', 'RFLOOR'],
  ['\\\\bigr\\s*\\\\rfloor', 'RFLOOR'],
  ['\\\\Bigr\\s*\\\\rfloor', 'RFLOOR'],
  ['\\\\biggr\\s*\\\\rfloor', 'RFLOOR'],
  ['\\\\Biggr\\s*\\\\rfloor', 'RFLOOR'],
  ['\\\\lceil', 'LCEIL'],
  ['\\\\left\\s*\\\\lceil', 'LCEIL'],
  ['\\\\bigl\\s*\\\\lceil', 'LCEIL'],
  ...
  ['\\\\Biggr\\s*\\\\rceil', 'RCEIL'],
  ['\\\\langle', 'LANGLE'],
  ['\\\\left\\s*\\\\langle', 'LANGLE'],
  ['\\\\bigl\\s*\\\\langle', 'LANGLE'],
  ['\\\\Bigl\\s*\\\\langle', 'LANGLE'],
  ['\\\\biggl\\s*\\\\langle', 'LANGLE'],
  ['\\\\Biggl\\s*\\\\langle', 'LANGLE'],
  ['\\\\rangle', 'RANGLE'],
  ['\\\\right\\s*\\\\rangle', 'RANGLE'],
  ['\\\\bigr\\s*\\\\rangle', 'RANGLE'],
  ['\\\\Bigr\\s*\\\\rangle', 'RANGLE'],
  ['\\\\biggr\\s*\\\\rangle', 'RANGLE'],
  ['\\\\Biggr\\s*\\\\rangle', 'RANGLE'],
  ['\\\\cdot(?![a-zA-Z])', '*'],
  ['\\\\div(?![a-zA-Z])', '/'],
  ['\\\\times(?![a-zA-Z])', '*'],
...
const allowedLatexSymbolsDefault = ['alpha', 'beta', 'gamma', 'Gamma', 'delta', 'Delta', 'epsilon', 'zeta', 'eta', 'theta', 'Theta', 'iota', 'kappa', 'lambda', 'Lambda', 'mu', 'nu', 'xi', 'Xi', 'pi', 'Pi', 'rho', 'sigma', 'Sigma', 'tau', 'Tau', 'upsilon', 'Upsilon', 'phi', 'Phi', 'chi', 'psi', 'Psi', 'omega', 'Omega', 'partial', 'angle'];
...
class latexToAst {
  ...
  expression(params) {
    ...
    while (['+', '-', 'UNION', 'INTERSECT', 'PERP'].includes(this.token.token_type)) {
  ...
  factor(params) {
    ...
    if(result === false && params.in_exponent_with_no_delimiters) {
    ...
    if (this.token.token_type === 'NUMBER') {
      ...
      if (this.token.token_type === 'LATEXCOMMAND') {
        ...
        if (!(this.appliedFunctionSymbols.includes(result)
          ...
          || this.operatorSymbols.includes(result)
        )) {
      ...
      this.advance();
    } else if (this.token.token_type === 'LFLOOR' || this.token.token_type === 'LCEIL') {
      ...
      if (this.token.token_type !== expected_right) {
        throw new ParseError('Expecting ' + expected_right, this.lexer.location);
      }
  ...
  leibniz_notation() {
    ...
    if (this.token.token_type === 'VAR')
      ...
      // strip out name of variable from \operatorname command
      var1 = /\\operatorname\s*\{\s*([a-zA-Z0-9\+\-]+)\s*\}/.exec(this.token.token_text)[1];
    }
    ...
    while (true) {
      ...
      if (this.token.token_type === 'VAR')
        ...
        // strip out name of variable from \operatorname command
        var2s.push(/\\operatorname\s*\{\s*([a-zA-Z0-9\+\-]+)\s*\}/.exec(this.token.token_text)[1]);
      }
      else if (this.token.token_type === 'LATEXCOMMAND') {
