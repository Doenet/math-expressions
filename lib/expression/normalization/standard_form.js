...
function normalize_negative_numbers(expr_or_tree) {
  ...
  if (operator === "-" && operands.length === 1) {
    ...
    if (Array.isArray(operands[0]) && operands[0][0] === "*") {
      // ["-", ["*", 3, x]]  =>  ["*", -3, x]
      if (typeof operands[0][1] === "number" && operands[0][1] >= 0) {
        return [
          "*",
          -operands[0][1],
      ...
      if (
        ...
        operands[0][1][0] === "/" &&
        operands[0][1].length === 3
      ) {
        // ["-", ["*", ["/", 3, "y"], x]]  =>  ["*", ["/", -3, "y"], x]
        if (typeof operands[0][1][1] === "number" && operands[0][1][1] >= 0) {
          return [
            "*",
            [
              "/",
              -1 * operands[0][1][1],
              normalize_negative_numbers(operands[0][1][2]),
            ],
            ...operands[0].slice(2).map(normalize_negative_numbers),
          ];
        }
        ...
        if (typeof operands[0][1][1] === "number" && operands[0][1][1] >= 0) {
          return [
            ...
            [
              "*",
              -1 * operands[0][1][1],
              ...operands[0][1].slice(2).map(normalize_negative_numbers),
            ],
            normalize_negative_numbers(operands[0][2]),
          ];
        }
