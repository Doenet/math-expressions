...
describe("discrete infinite", function () {
  test("basic equality", function () {
    ...
    var set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("pi/4, 5pi/4"),
      periods: me.fromText("2pi"),
    });
    expect(set1.equals(set2)).toBeTruthy();

    set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("pi/4"),
      periods: me.fromText("2*pi"),
    });
    expect(set1.equals(set2)).toBeFalsy();

    set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("9*pi/4"),
      periods: me.fromText("pi"),
    });
    expect(set1.equals(set2)).toBeTruthy();

    set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("7*pi/4"),
      periods: me.fromText("pi"),
    });
    expect(set1.equals(set2)).toBeFalsy();
    ...
    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("-pi/4, pi/4, 11pi/4, -11pi/4"),
      periods: me.fromText("2pi"),
    });
    expect(set1.equals(set2)).toBeTruthy();
  });
  ...
  test("overcounting", function () {
    var set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("1"),
      periods: me.fromText("5"),
    });
    var set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("1, 1, 6, 11, 16, 21"),
      periods: me.fromText("10"),
    });
    expect(set1.equals(set2)).toBeTruthy();

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("1, 1, 6, 11, 16, 22"),
      periods: me.fromText("10"),
    });
    expect(set1.equals(set2)).toBeFalsy();
  });
  ...
  test("match partial", function () {
    ...
    var set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("1, 16"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(1);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("1, 15"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0.5);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("1, 16, 17"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toBeCloseTo(
      2 / 3,
    );

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0);

    set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("1, 2"),
      periods: me.fromText("5"),
    });
    ...
    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15, 17"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0.5);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15, 16, 17"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0.75);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15, 16, 17, 18"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0.6);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15, 16"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0.5);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15, 16, 18"),
      periods: me.fromText("10"),
    });
    expect(discreteEquals(set1, set2, { match_partial: true })).toEqual(0.5);

    set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("2, 15, 16, 18, 19"),
      periods: me.fromText("10"),
    });
  ...
  test("variables", function () {
    var set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("a"),
      periods: me.fromText("3"),
    });
    var set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("a, a+3, a+6"),
      periods: me.fromText("9"),
    });
    expect(set1.equals(set2)).toBeTruthy();

    set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("b"),
      periods: me.fromText("3"),
    });
    expect(set1.equals(set2)).toBeFalsy();
  });
  ...
  test("assumptions", function () {
    ...
    var set1 = me.create_discrete_infinite_set({
      offsets: me.fromText("a"),
      periods: me.fromText("c"),
    });
    var set2 = me.create_discrete_infinite_set({
      offsets: me.fromText("a, a+c"),
      periods: me.fromText("2c"),
    });
  ...
  test("compare with list", function () {
    var set = me.create_discrete_infinite_set({
      offsets: me.fromText("0"),
      periods: me.fromText("7"),
