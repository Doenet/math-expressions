...
const unicode_operators = {
  ...
  "rightarrow": function (operands) { return operands.join(' → '); },
  "leftarrow": function (operands) { return operands.join(' ← '); },
  "leftrightarrow": function (operands) { return operands.join(' ↔ '); },
  "implies": function (operands) { return operands.join(' ⟹ '); },
  "impliedby": function (operands) { return operands.join(' ⟸ '); },
  "iff": function (operands) { return operands.join(' ⟺ '); },
...
const nonunicode_operators = {
  ...
  "rightarrow": function (operands) { return operands.join(' rightarrow '); },
  "leftarrow": function (operands) { return operands.join(' leftarrow '); },
  "leftrightarrow": function (operands) { return operands.join(' leftrightarrow '); },
  "implies": function (operands) { return operands.join(' implies '); },
  "impliedby": function (operands) { return operands.join(' impliedby '); },
  "iff": function (operands) { return operands.join(' iff '); },
...
class astToText {
  ...
  statement(tree) {
    ...
    if(['implies', 'impliedby', 'iff', 'rightarrow', 'leftarrow', 'leftrightarrow'].includes(operator)) {
        ...
        if (eIndex === -1) {
          if (this.padToDigits !== null || this.padToDecimals !== null) {
            numberString = padNumberStringToDigitsAndDecimals(
              numberString, this.padToDigits, this.padToDecimals
            );
          }
          return numberString;
        }
        ...
        if (this.padToDigits !== null || this.padToDecimals !== null) {
          ...
          if (exponentNumber > 0 && this.padToDecimals !== null) {
            ...
            num = padNumberStringToDigitsAndDecimals(
              num, this.padToDigits, padDecimals
            );
          }
        }
        if (exponent[0] === "+") {
